...
int fl_write_png(const char *filename, const char *pixels, int w, int h, int d=3, int ld=0);
int fl_write_png(const char *filename, const unsigned char *pixels, int w, int h, int d=3, int ld=0);
